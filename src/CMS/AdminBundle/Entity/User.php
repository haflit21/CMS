...
class User implements UserInterface, \Serializable
{
     ...
     * Add groups
     *
     * @param CMS\AdminBundle\Entity\Group $groups
     */
    public function addGroup(\CMS\AdminBundle\Entity\Role $groups)
    {
        $this->groups[] = $groups;
    }
     ...
     * @param CMS\AdminBundle\Entity\Group $groups
     */
    public function removeGroup(\CMS\AdminBundle\Entity\Role $groups)
    {
