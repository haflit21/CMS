 ...
 *
 */
class LinkField extends Fields
{
    private $html;
    ...
    public function display($value)
    {
        ...
        if($value != '')
            $html = $start.'<a href="'.$value.'" target="'.$this->getParamsValue($this->params, 'target').'"><i class="li_note"></i></a>'.$end;
    ...
    public function getOptions()
    {
        $options = '
            ...
            <select id="target" name="options[target]">
                <option '.$this->getParamsValue($this->params, 'target', 'select', '_blank').' value="_blank">Nouvelle fenêtre</option>
                <option '.$this->getParamsValue($this->params, 'target', 'select', '_self').' value="_self">Même fenêtre</option>
            </select>    
