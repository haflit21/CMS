...
class TagField extends Fields
{
    ...
    public function displayfield($field, $value=null)
    {
        ...
        $html .= '<div class="controls"><input type="text" class="input-tags" name="'.$field->getName().'" value="'.htmlentities($value).'" size="'.$this->getParamsValue($this->params, 'size').'" data-provide="tag" /></div></div>';
