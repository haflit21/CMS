...
class BlocRepository extends EntityRepository
{
    ...
    public function getBlocByLangIdQuery($lang)
    {

        return $this->_em
                    ->createQueryBuilder('b')
                    ->Select('b')
                    ->from('CMSBlocBundle:Bloc','b')
    ...
    public function getBlocBaseAdmin($position, $lang='fr')
    {
            return $this->getEntityManager()
                    ->createQueryBuilder('b')
                    ->Select('b')
                    ...
                    ->setParameter('position', $position)
                    ->setParameter('published', 1)
                    ->orderBy('b.position, b.ordre', 'asc')
                    ->getQuery()
                    ->getResult();
    }
    ...
    public function getBlocBaseDefault($position,$lang=1)
    {
        return $this->getEntityManager()
                    ->createQueryBuilder('b')
                    ->Select('b')
